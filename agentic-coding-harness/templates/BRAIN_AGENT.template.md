...
### Recommendations — 🔴 / 🟡 / 🟢
### Deployment Conditions — [ ] CCR complete · [ ] deviations disclosed & reviewed · [ ] contract all-yes · [ ] contracts asserted + observability-logged at boundaries · [ ] no parallel convention/half-migration · [ ] docs updated · [ ] rollback concrete · [ ] {{your gates}}
```
