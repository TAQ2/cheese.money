...
const status = {
  ...
  logPath: "/home/me/.ch3/userdata/logs/boot-service.log",
} as const;
...
it("reports the installed service version and host paths", () => {
  assert.equal(
    ...
    [
      "CH3 service",
      "  Status: installed · ch3@0.0.29",
      "  Unit: /home/me/.config/systemd/user/ch3.service",
      "  Logs: /home/me/.ch3/userdata/logs/boot-service.log",
    ].join("\n"),
  );
});
