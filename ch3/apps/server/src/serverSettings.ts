...
import { type DeepPartial, deepMerge } from "@ch3tools/shared/Struct";
import { fromJsonStringPretty, fromLenientJson } from "@ch3tools/shared/schemaJson";
import {
  applyServerSettingsPatch,
  isModelSelectionProviderEnabled,
} from "@ch3tools/shared/serverSettings";
import * as ServerSecretStore from "./auth/ServerSecretStore.ts";

export { resolveSourceControlWriterModelSelection } from "@ch3tools/shared/serverSettings";
...
>()("ch3/serverSettings/ServerSettingsService") {
