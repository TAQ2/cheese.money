  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `ch3-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "CH3",
        GIT_AUTHOR_EMAIL: "ch3@users.noreply.github.com",
        GIT_COMMITTER_NAME: "CH3",
        GIT_COMMITTER_EMAIL: "ch3@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `ch3 checkpoint ref=${input.checkpointRef}`;
