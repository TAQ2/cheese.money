import { ProjectId } from "@ch3tools/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@ch3tools/shared/projectScripts";
...
>()("ch3/project/ProjectSetupScriptRunner") {}
