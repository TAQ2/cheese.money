import { readConnectAuthorizeRequest } from "@ch3tools/shared/connectAuth";
...
const TEST_ENV = {
  CH3CODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  CH3CODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  CH3CODE_HOSTED_APP_URL: "https://hosted.example.test",
};
