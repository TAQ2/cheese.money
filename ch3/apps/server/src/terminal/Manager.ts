...
import { makeKeyedCoalescingWorker } from "@ch3tools/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@ch3tools/shared/hostProcess";
import { getTerminalLabel } from "@ch3tools/shared/terminalLabels";
...
>()("ch3/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("CH3CODE_")) {
    return true;
  }
...
// (e.g. /tmp/.mount_CH3-XXXX/usr/bin). Only the mount segments are dropped; the
