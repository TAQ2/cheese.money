...
import Migration0036 from "./Migrations/036_ProjectionThreadsKanban.ts";
import Migration0038 from "./Migrations/038_ClaudeAccountRiddles.ts";
import Migration0039 from "./Migrations/039_ProjectionThreadLiveDelegations.ts";
import Migration0040 from "./Migrations/040_ProjectionThreadActivityKindIndex.ts";
import Migration0041 from "./Migrations/041_ProjectionThreadSessionLastErrorClass.ts";
...
export const migrationEntries = [
  ...
  [36, "ProjectionThreadsKanban", Migration0036],
  [38, "ClaudeAccountRiddles", Migration0038],
  [39, "ProjectionThreadLiveDelegations", Migration0039],
  [40, "ProjectionThreadActivityKindIndex", Migration0040],
  [41, "ProjectionThreadSessionLastErrorClass", Migration0041],
] as const;
