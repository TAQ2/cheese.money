 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@ch3tools/contracts";
...
>()("ch3/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
