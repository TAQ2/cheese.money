...
import { isDevProxiedPath } from "@ch3tools/shared/devProxy";
import { decodeOtlpTraceRecords } from "@ch3tools/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["ch3://app", "ch3-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // CH3CODE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
