import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@ch3tools/contracts";
...
import { KeybindingsConfigError } from "@ch3tools/contracts";
