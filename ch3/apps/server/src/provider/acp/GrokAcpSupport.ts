import { type GrokSettings, ProviderDriverKind } from "@ch3tools/contracts";
...
import { normalizeModelSlug } from "@ch3tools/shared/model";
...
const CH3_CODE_OAUTH_REFERRER = "ch3";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: CH3_CODE_OAUTH_REFERRER,
    },
  };
}
