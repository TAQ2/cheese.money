...
export const hydrateCachedProvider = (input: {
  ...
  const hydratedProvider: ServerProvider = {
    ...
    ...(input.cachedProvider.outputStyles
      ? { outputStyles: input.cachedProvider.outputStyles }
      : {}),
    ...(input.cachedProvider.activeOutputStyle
      ? { activeOutputStyle: input.cachedProvider.activeOutputStyle }
      : {}),
  };
