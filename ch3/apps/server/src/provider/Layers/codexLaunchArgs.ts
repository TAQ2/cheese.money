import { tokenizeCliArgs } from "@ch3tools/shared/cliArgs";

export const CH3CODE_CODEX_LAUNCH_ARGS_ENV = "CH3CODE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[CH3CODE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
