...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@ch3tools/shared/path";
import { normalizeSearchQuery } from "@ch3tools/shared/searchRanking";
...
>()("ch3/workspace/WorkspaceEntries") {}
