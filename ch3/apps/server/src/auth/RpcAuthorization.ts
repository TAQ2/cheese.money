...
export const RPC_REQUIRED_SCOPES = {
  ...
  // Reading a reply aloud consumes thread content and spawns a local process,
  // so it sits with the operate scope rather than plain read.
  [WS_METHODS.speechSynthesize]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.threadsListRewindTargets]: AuthOrchestrationReadScope,
  [WS_METHODS.threadsRewindFiles]: AuthOrchestrationOperateScope,
  [WS_METHODS.claudeResolveExternalSession]: AuthOrchestrationReadScope,
  [WS_METHODS.threadsAdoptClaudeSession]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadsRewindToInput]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.vcsFetchRemote]: AuthOrchestrationOperateScope,
