import { EnvironmentHttpApi } from "@ch3tools/contracts";
...
import { disableTailscaleServe, ensureTailscaleServe } from "@ch3tools/tailscale";

// Effect's default preemptive shutdown waits 20s before finalizing request scopes.
// CH3's primary transport is long-lived WebSocket RPC, whose Effect scope finalizer
      ...
      Effect.gen(function* () {
        ...
        yield* Effect.forkScoped(
          Effect.sleep("250 millis").pipe(
            ...
            Effect.tap(() => Effect.logInfo("CH3 Connect desired link reconciled on startup")),
            Effect.catch((cause) =>
              Effect.logWarning("Failed to reconcile CH3 Connect desired link on startup", {
                cause,
              }),
            ),
          ),
