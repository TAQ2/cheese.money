...
import { SourceControlProviderError, type ChangeRequest } from "@ch3tools/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set CH3CODE_BITBUCKET_EMAIL and CH3CODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
