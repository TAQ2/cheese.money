    ...
    const provider = yield* makeProvider({
      getPullRequest: () =>
        Effect.succeed({
          ...
          url: "https://github.com/pingdotgg/ch3/pull/42",
          baseRefName: "main",
          headRefName: "feature/source-control",
          state: "open",
          isCrossRepository: true,
          headRepositoryNameWithOwner: "fork/ch3",
...
it.effect("adds safe request context while retaining GitHub CLI causes", () =>
  Effect.gen(function* () {
    ...
    const error = yield* provider
      .getChangeRequest({
        cwd: "/repo",
        reference: "https://user:secret@github.com/pingdotgg/ch3/pull/42?token=secret#diff",
      })
      .pipe(Effect.flip);
    ...
    assert.deepStrictEqual(
      ...
      },
      {
        ...
        command: "gh",
        cwd: "/repo",
        reference: "https://github.com/pingdotgg/ch3/pull/42",
            ...
            JSON.stringify([
              {
                number: 7,
                title: "Merged work",
                url: "https://github.com/pingdotgg/ch3/pull/7",
                baseRefName: "main",
