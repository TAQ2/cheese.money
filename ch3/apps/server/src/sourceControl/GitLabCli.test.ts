...
import { VcsProcessExitError } from "@ch3tools/contracts";
  ...
  it.effect("parses merge request view output", () =>
    Effect.gen(function* () {
        ...
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              ...
              web_url: "https://gitlab.com/pingdotgg/ch3/-/merge_requests/42",
              target_branch: "main",
              ...
              source_project: {
                path_with_namespace: "octocat/ch3",
              },
            }),
          ),
        ),
      ...
      assert.deepStrictEqual(result, {
        number: 42,
        title: "Add MR thread creation",
        url: "https://gitlab.com/pingdotgg/ch3/-/merge_requests/42",
        baseRefName: "main",
            ...
            JSON.stringify([
              {
                iid: 0,
                title: "invalid",
                web_url: "https://gitlab.com/pingdotgg/ch3/-/merge_requests/0",
                target_branch: "main",
              ...
              },
              {
                iid: 43,
                title: "  Valid MR  ",
                web_url: " https://gitlab.com/pingdotgg/ch3/-/merge_requests/43 ",
                target_branch: " main ",
      ...
      assert.deepStrictEqual(result, [
        {
          number: 43,
          title: "Valid MR",
          url: "https://gitlab.com/pingdotgg/ch3/-/merge_requests/43",
          baseRefName: "main",
    ...
    Effect.gen(function* () {
      mockedRun.mockReturnValueOnce(
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              path_with_namespace: "octocat/ch3",
              web_url: "https://gitlab.com/octocat/ch3",
              http_url_to_repo: "https://gitlab.com/octocat/ch3.git",
              ssh_url_to_repo: "git@gitlab.com:octocat/ch3.git",
            }),
          ),
        ),
      );
      ...
      const result = yield* Effect.gen(function* () {
        ...
        return yield* glab.getRepositoryCloneUrls({
          cwd: "/repo",
          repository: "octocat/ch3",
        });
      });

      assert.deepStrictEqual(result, {
        nameWithOwner: "octocat/ch3",
        url: "https://gitlab.com/octocat/ch3",
        sshUrl: "git@gitlab.com:octocat/ch3.git",
      });
    }),
  );
      ...
      expect(mockedRun).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          args: [
            ...
            "title=Provider MR",
            "--field",
            "description=@/tmp/ch3-mr-body.md",
          ],
        }),
      );
    }),
