# CH3 Mobile Terminal Native Module
...
fork, with CH3's iOS 16 compatibility patch applied. `CH3TerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/ch3-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/ch3-terminal/scripts/build-libghostty-android.sh
```
