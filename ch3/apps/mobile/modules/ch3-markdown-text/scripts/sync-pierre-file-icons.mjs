...
const customSprite = webIconSource.match(/const CH3_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the CH3 Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "ch3-file-icon-agents",
  claude: "ch3-file-icon-claude",
  package: "ch3-file-icon-package-json",
  pnpm: "ch3-file-icon-pnpm",
  readme: "ch3-file-icon-readme",
  tsconfig: "ch3-file-icon-tsconfig",
};
