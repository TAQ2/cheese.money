...
} from "@ch3tools/client-runtime/platform";
import { ConnectionTransientError } from "@ch3tools/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "ch3.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "ch3.connections";
