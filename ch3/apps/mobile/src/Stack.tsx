...
function RootStackLayout(props: {
  ...
  // Presents the CH3 Connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-ch3-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-ch3-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
