import { isTransportConnectionErrorMessage } from "@ch3tools/client-runtime/errors";
import type { EnvironmentShellStatus } from "@ch3tools/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,
