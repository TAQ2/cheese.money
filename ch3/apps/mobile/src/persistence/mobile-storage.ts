...
const CONNECTIONS_KEY = "ch3.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "ch3.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "ch3.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "ch3.recent-thread-shortcuts";
...
>()("@ch3tools/mobile/persistence/MobileStorage") {}
