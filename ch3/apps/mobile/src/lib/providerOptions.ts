...
export function applyProviderOptionMenuEvent(
  ...
  event: string,
  /**
   * The selections being replaced. Needed because the rebuild below knows only
   * about descriptors, and options that have none — the response style — would
   * otherwise be dropped every time a trait is touched.
   */
  previousOptions?: ReadonlyArray<ProviderOptionSelection> | null | undefined,
