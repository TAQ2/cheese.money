import type { EnvironmentProject } from "@ch3tools/client-runtime/state/shell";
import { EnvironmentId, ProjectId, ProviderInstanceId } from "@ch3tools/contracts";
...
const projects: ReadonlyArray<EnvironmentProject> = [
  {
    ...
    id: ProjectId.make("ch3"),
    title: "CH3",
    workspaceRoot: "/workspace/ch3",
