import type { EnvironmentId, SidebarThreadSortOrder } from "@ch3tools/contracts";
...
import { CH3Wordmark } from "../../components/CH3Wordmark";
        ...
        <View className="w-full max-w-[720px] self-center gap-3">
          <View className="flex-row items-center gap-2.5">
            <View className="flex-1 flex-row items-center gap-2">
              {/* Mirrors the desktop SidebarBrand: CH3 mark + muted "Code". */}
              <CH3Wordmark color={iconColor} height={15} />
              <RNText className="-ml-0.5 text-[21px] font-ch3-medium tracking-[-0.5px] text-foreground-muted">
                Code
              </RNText>
              <View className="rounded-full bg-subtle px-2 py-0.75">
                <RNText className="text-[11px] font-ch3-bold tracking-[1.1px] text-foreground-muted uppercase">
                  Alpha
                </RNText>
              </View>
            </View>
