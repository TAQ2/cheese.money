...
export const ThreadListV2SectionDivider = memo(function ThreadListV2SectionDivider(props: {
  ...
  return (
    ...
    >
      <Text className="text-xs font-ch3-medium text-foreground-tertiary">{props.label}</Text>
  ...
  const rowContent = (
    <>
      <View className="flex-row items-center gap-1.5">
        ...
        <Text className="flex-1 text-sm font-ch3-medium text-foreground-muted" numberOfLines={1}>
          {projectTitle}
        </Text>
      ...
      <Text className="mt-1 text-base font-ch3-medium text-foreground" numberOfLines={1}>
        {pendingTask.title}
      </Text>
  ...
  const cardContent = (
    <>
      <View className="flex-row items-center gap-1.5">
        ...
        <Text
          className={cn(
            "flex-1 text-sm font-ch3-medium",
      ...
      <Text
        className={cn(
          "mt-1 text-base font-ch3-medium",
