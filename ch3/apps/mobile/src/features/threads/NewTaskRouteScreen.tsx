...
import type { EnvironmentId, ProjectId } from "@ch3tools/contracts";
      ...
      >
        {items.length === 0 ? (
          <View collapsable={false} className="items-center gap-3 rounded-[24px] bg-card px-6 py-8">
            ...
            <Text className="text-center text-lg font-ch3-bold text-foreground">
                ...
                >
                  <View className="flex-row items-center justify-between gap-3">
                    ...
                    <View className="flex-1">
                      <Text className="text-base leading-snug font-ch3-bold">{item.title}</Text>
                    </View>
                    <SymbolView
                      name="chevron.right"
                      size={14}
