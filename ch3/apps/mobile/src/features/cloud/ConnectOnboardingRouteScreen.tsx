...
import { reportAtomCommandResult, settlePromise } from "@ch3tools/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for CH3 Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's CH3 Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your CH3 account to set up CH3 Connect.
            </Text>
          </View>
        )}
