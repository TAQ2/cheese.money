...
const isIosPersonalTeamBuild = repoEnv.CH3CODE_IOS_PERSONAL_TEAM === "1";

const personalTeamBundleIdentifier = repoEnv.CH3CODE_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "CH3CODE_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.ch3 when CH3CODE_IOS_PERSONAL_TEAM=1.",
  );
}
...
const VARIANT_CONFIG = {
  development: {
    appName: "CH3 Dev",
    scheme: "ch3-dev",
    iosBundleIdentifier: "com.ch3tools.ch3.dev",
    androidPackage: "com.ch3tools.ch3.dev",
    relyingParty: "clerk.ch3.codes",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "CH3 Preview",
    scheme: "ch3-preview",
    iosBundleIdentifier: "com.ch3tools.ch3.preview",
    androidPackage: "com.ch3tools.ch3.preview",
    relyingParty: "clerk.ch3.codes",
  ...
  production: {
    appName: "CH3",
    scheme: "ch3",
    iosBundleIdentifier: "com.ch3tools.ch3",
    androidPackage: "com.ch3tools.ch3",
    relyingParty: "clerk.ch3.codes",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active CH3 agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    // Pin code signing to the CH3 Tools team so non-interactive `expo run:ios`
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow CH3 to connect to CH3 servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow CH3 to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    relay: {
      url: repoEnv.CH3CODE_RELAY_URL ?? null,
    },
    clerk: {
