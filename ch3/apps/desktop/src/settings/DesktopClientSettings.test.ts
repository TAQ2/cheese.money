...
import { ClientSettingsSchema, type ClientSettings } from "@ch3tools/contracts";
...
const clientSettings: ClientSettings = {
  ...
  sidebarAutoArchiveAfterSettledDays: 4,
...
const withClientSettings = <A, E, R>(
  ...
  Effect.gen(function* () {
    ...
    const baseDir = yield* fileSystem.makeTempDirectoryScoped({
      prefix: "ch3-desktop-client-settings-test-",
    });
