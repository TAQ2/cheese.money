...
import { waitForHttpReady as waitForHttpReadyShared } from "@ch3tools/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/ch3/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // CH3CODE_HOME can't pin the WSL backend to /mnt/c/...\.ch3.
