...
export const CLAUDE_SIGN_IN_EMAIL_HINT_CHANNEL = "desktop:claude-sign-in-email-hint";
export const MENU_ACTION_CHANNEL = "desktop:menu-action";
export const SET_AGENT_ACTIVITY_CHANNEL = "desktop:set-agent-activity";
export const POWER_RESUME_CHANNEL = "desktop:power-resume";
...
/** The renderer asks for a plain relaunch, with a reason for the lifecycle log. */
