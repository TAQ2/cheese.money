...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteCH3ServerEntryPath: Option.Option<string>;
...
>()("@ch3tools/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "CH3";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const configuredBaseDir = config.ch3Home;
  const baseDir = Option.getOrElse(configuredBaseDir, () => path.join(homeDirectory, ".ch3"));
  ...
  const userDataDirName = isDevelopment ? "ch3-dev" : "ch3";
  const legacyUserDataDirName = isDevelopment ? "CH3 (Dev)" : "CH3 (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteCH3ServerEntryPath: config.devRemoteCH3ServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.ch3tools.ch3.dev" : "com.ch3tools.ch3",
    ),
    linuxDesktopEntryName: isDevelopment ? "ch3-dev.desktop" : "ch3.desktop",
    linuxWmClass: isDevelopment ? "ch3-dev" : "ch3",
    userDataDirName,
