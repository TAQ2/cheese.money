...
// One port away from upstream's 3773: the readiness probe cannot tell two
// servers apart, so sharing a port makes whichever app starts second adopt
// the first one's backend. CH3 owns 3873.
...
export class DesktopDevelopmentBackendPortRequiredError extends Schema.TaggedErrorClass<DesktopDevelopmentBackendPortRequiredError>()(
  ...
  override get message(): string {
    return "CH3CODE_PORT is required in desktop development.";
  }
}
