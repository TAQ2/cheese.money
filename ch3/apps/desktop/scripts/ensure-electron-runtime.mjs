...
// oxlint-disable-next-line ch3/no-global-process-runtime -- Standalone repair script has no Effect runtime.
...
function installElectronRuntime(electronDir, version) {
  const tempDir = NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "ch3-electron-"));
