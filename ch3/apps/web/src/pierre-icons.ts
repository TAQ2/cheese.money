...
const PIERRE_ICON_SPRITE_ID = "ch3-pierre-file-icon-sprite";

const CH3_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="ch3-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="ch3-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="ch3-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="ch3-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="ch3-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="ch3-file-icon-pnpm" viewBox="0 0 32 32">
...
export const CH3_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: CH3_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "ch3-file-icon-package-json",
    "tsconfig.json": "ch3-file-icon-tsconfig",
    "agents.md": "ch3-file-icon-agents",
    "claude.md": "ch3-file-icon-claude",
    "readme.md": "ch3-file-icon-readme",
    "pnpm-lock.yaml": "ch3-file-icon-pnpm",
    "pnpm-workspace.yaml": "ch3-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(CH3_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${CH3_FILE_ICON_SPRITE}`;
