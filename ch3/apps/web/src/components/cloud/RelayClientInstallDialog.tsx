...
import type { RelayClientInstallProgressStage } from "@ch3tools/contracts";
    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={isConfirming}>
        <DialogHeader>
          ...
          <DialogDescription>
            {isInstalling
              ? "CH3 is preparing this environment for secure access through CH3 Connect."
              : "CH3 needs the relay client to make this environment available through CH3 Connect."}
          </DialogDescription>
        </DialogHeader>
          ...
          {isInstalling ? (
            <div className="space-y-2.5">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground">
                Keep CH3 open while the relay client is installed.
              </p>
            </div>
          ) : (
            <div className="rounded-xl border border-border/70 bg-muted/35 p-3">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                CH3 will download and install version{" "}
