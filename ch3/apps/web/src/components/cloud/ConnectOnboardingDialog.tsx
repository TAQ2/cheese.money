...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@ch3tools/contracts";
...
/**
 * Post-sign-in onboarding wizard for CH3 Connect. Opens on every in-session
 ...
 * account's CH3 Connect environments so every device can be connected right
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up CH3 Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through CH3 Connect."
