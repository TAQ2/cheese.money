...
/**
 * The marks of the MCP catalogue, drawn the size of a favicon. Simple Icons
 * geometry (CC0) in each brand's own colour; Notion is black on white and
 * white on black, like OpenAI above. CH3's mark is the company's own
 * vector; CH3's is this app's favicon and Braze's the favicon its site
 * serves, rasters both, because no vector of either exists. Slack's is its
 * own public brand mark instead of Simple Icons', the four-colour
 * "octothorpe" from Slack's media kit, not the single-colour geometry Simple
 * Icons carries for it.
 */
export const NotionIcon: Icon = ({ className, ...props }) => (
...
export const SentryIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#362D59">
...
export const MetabaseIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#509EE3">
...
export const DatadogIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#632CA6">
...
export const SlackIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 122.8 122.8">
    <path
...
export const GoogleDriveIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#4285F4">
    <path d="M12.01 1.485c-2.082 0-3.754.02-3.743.047.01.02 1.708 3.001 3.774 6.62l3.76 6.574h3.76c2.081 0 3.753-.02 3.742-.047-.005-.02-1.708-3.001-3.775-6.62l-3.76-6.574zm-4.76 1.73a789.828 789.861 0 0 0-3.63 6.319L0 15.868l1.89 3.298 1.885 3.297 3.62-6.335 3.618-6.33-1.88-3.287C8.1 4.704 7.255 3.22 7.25 3.214zm2.259 12.653-.203.348c-.114.198-.96 1.672-1.88 3.287a423.93 423.948 0 0 1-1.698 2.97c-.01.026 3.24.042 7.222.042h7.244l1.796-3.157c.992-1.734 1.85-3.23 1.906-3.323l.104-.167h-7.249z" />
  </svg>
);

export const GoogleCalendarIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#4285F4">
...
export const GoogleDocsIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#4285F4">
...
export const GoogleSheetsIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#34A853">
    <path d="M11.318 12.545H7.91v-1.909h3.41v1.91zM14.728 0v6h6l-6-6zm1.363 10.636h-3.41v1.91h3.41v-1.91zm0 3.273h-3.41v1.91h3.41v-1.91zM20.727 6.5v15.864c0 .904-.732 1.636-1.636 1.636H4.909a1.636 1.636 0 0 1-1.636-1.636V1.636C3.273.732 4.005 0 4.909 0h9.318v6.5h6.5zm-3.273 2.773H6.545v7.909h10.91v-7.91zm-6.136 4.636H7.91v1.91h3.41v-1.91z" />
  </svg>
);

export const GoogleSlidesIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#FBBC04">
...
const CH3_ICON_DATA_URL =
  "data:image/png;base64,";

export const CH3Icon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="none">
    <image href={CH3_ICON_DATA_URL} width="32" height="32" />
  </svg>
);

const BRAZE_ICON_DATA_URL =
  "data:image/png;base64,";

export const BrazeIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="none">
    <image href={BRAZE_ICON_DATA_URL} width="32" height="32" />
  </svg>
);
