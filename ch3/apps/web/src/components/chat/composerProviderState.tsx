...
export function getComposerProviderState(input: ComposerProviderStateInput): ComposerProviderState {
  ...
  return {
    provider,
    promptEffort,
    // The rebuild only knows about descriptors, so the thread's output style
    // has to be carried across explicitly or it never reaches the turn.
    modelOptionsForDispatch: withDescriptorlessProviderOptionSelections(
