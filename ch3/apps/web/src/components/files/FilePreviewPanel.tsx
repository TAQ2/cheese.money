...
import { isWorkspaceImagePreviewPath } from "@ch3tools/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "ch3.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "ch3.renderMarkdown";
