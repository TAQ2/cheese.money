import type { EnvironmentId, ServerSelfUpdateCapability } from "@ch3tools/contracts";
import type { ServerUpdateState } from "@ch3tools/client-runtime/state/server";
import {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toastManager.add({
        ...
        description: `Reconnected on ch3@${result.value.targetVersion}.`,
      });
    } finally {
