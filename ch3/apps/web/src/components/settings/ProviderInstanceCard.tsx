...
export function ProviderInstanceCard({
  ...
  // Claude accounts are config directories; the switcher reads and writes
  // this instance's `homePath` setting.
  const accountSwitcherEnvironmentId = usePrimaryEnvironmentId();
              ...
              {driverKind === "claudeAgent" && accountSwitcherEnvironmentId ? (
                <ClaudeAccountSwitcher
                  ...
                  onSelectHomePath={(homePath) => {
                    ...
                    // instance at the other config directory. Nothing is
                    // signed out, so switching back is instant.
                    const { config: _omit, ...rest } = instance;
                    onUpdate({
                      ...rest,
                      config: nextConfigBlobWithValue(instance.config, "homePath", homePath),
                    } as ProviderInstanceConfig);
                  }}
                  failoverEnabled={claudeFailoverEnabled}
                  ...
                  rotationEnabled={claudeRotationEnabled}
