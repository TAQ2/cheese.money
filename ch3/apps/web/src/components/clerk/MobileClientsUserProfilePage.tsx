import type { RelayClientDeviceRecord } from "@ch3tools/contracts/relay";
  ...
  return (
    <Empty className="min-h-72 rounded-xl border border-dashed bg-muted/15">
      ...
      <EmptyHeader>
        ...
        <EmptyDescription>
          Sign in to CH3 on your iPhone to register it for push notifications and Live Activities.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
  );
      ...
      <header className="flex flex-col gap-4 border-b px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Devices registered to receive CH3 Connect activity from your environments.
          </p>
        </div>
        <Button
          size="sm"
