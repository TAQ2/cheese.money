...
import { RelayWebClientId } from "@ch3tools/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_CH3CODE_RELAY_URL", "https://relay.example.test");
