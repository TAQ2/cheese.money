  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new CH3 prerelease is available for nightly testers."
          : "A new CH3 latest release is available.",
...
).pipe(Command.withDescription("Post a CH3 release announcement to Discord."));
