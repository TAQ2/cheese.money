...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@ch3tools/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "ch3-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "ch3-relay-dpop-access+jwt";
