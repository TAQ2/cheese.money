...
The same configuration lives in `~/.ch3/userdata/keybindings.json` on the machine running the
server, if you prefer editing it directly. CH3 writes the built-in defaults into that file on
