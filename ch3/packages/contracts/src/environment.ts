...
/** What update path a client should offer for a server: one of the RPC
    ...
    version belongs to the CH3 desktop app supervising it — updating the
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** The server can answer speech.synthesize. Current servers synthesize
      ...
      hide the read-aloud control for those rather than offering one that
      fails. */
  speech: Schema.optionalKey(Schema.Boolean),
