...
} from "./providerSessionId.ts";
import {
  ProviderMcpActionInput,
  ProviderMcpActionResult,
  ProviderMcpStatusError,
  ProviderMcpStatusInput,
...
import {
  ...
  ThreadsAdoptClaudeSessionInput,
  ThreadsRewindToInputInput,
  ThreadsRewindToInputResult,
} from "./claudeSessionImport.ts";
import {
  ProviderRewindError,
  ProviderRewindFilesInput,
  ProviderRewindFilesResult,
  ProviderRewindTargetsInput,
  ProviderRewindTargetsResult,
...
export const WS_METHODS = {
  ...
  vcsFetchRemote: "vcs.fetchRemote",
  ...
  threadsListRewindTargets: "threads.listRewindTargets",
  threadsRewindFiles: "threads.rewindFiles",
  claudeResolveExternalSession: "claude.resolveExternalSession",
  threadsAdoptClaudeSession: "threads.adoptClaudeSession",
  threadsRewindToInput: "threads.rewindToInput",
...
export const WsClaudeStatusLineRenderRpc = Rpc.make(WS_METHODS.claudeStatusLineRender, {
...
export const WsThreadsGetProviderSessionIdRpc = Rpc.make(WS_METHODS.threadsGetProviderSessionId, {
  payload: ProviderSessionIdInput,
  success: ProviderSessionIdResult,
  error: Schema.Union([ProviderSessionIdError, EnvironmentAuthorizationError]),
});

export const WsThreadsGetMcpStatusRpc = Rpc.make(WS_METHODS.threadsGetMcpStatus, {
  payload: ProviderMcpStatusInput,
  success: ProviderMcpStatusResult,
  error: Schema.Union([ProviderMcpStatusError, EnvironmentAuthorizationError]),
});

export const WsThreadsMcpServerActionRpc = Rpc.make(WS_METHODS.threadsMcpServerAction, {
  payload: ProviderMcpActionInput,
  success: ProviderMcpActionResult,
  error: Schema.Union([ProviderMcpStatusError, EnvironmentAuthorizationError]),
});

export const WsThreadsListRewindTargetsRpc = Rpc.make(WS_METHODS.threadsListRewindTargets, {
  payload: ProviderRewindTargetsInput,
  success: ProviderRewindTargetsResult,
  error: Schema.Union([ProviderRewindError, EnvironmentAuthorizationError]),
});

export const WsThreadsRewindFilesRpc = Rpc.make(WS_METHODS.threadsRewindFiles, {
  payload: ProviderRewindFilesInput,
  success: ProviderRewindFilesResult,
  error: Schema.Union([ProviderRewindError, EnvironmentAuthorizationError]),
});

export const WsClaudeResolveExternalSessionRpc = Rpc.make(WS_METHODS.claudeResolveExternalSession, {
  payload: ClaudeExternalSessionInput,
  success: ClaudeExternalSessionResult,
  error: Schema.Union([ClaudeExternalSessionError, EnvironmentAuthorizationError]),
});

export const WsThreadsAdoptClaudeSessionRpc = Rpc.make(WS_METHODS.threadsAdoptClaudeSession, {
  payload: ThreadsAdoptClaudeSessionInput,
  success: Schema.Struct({}),
  error: Schema.Union([ClaudeExternalSessionError, EnvironmentAuthorizationError]),
});

export const WsClaudeListAccountProfilesRpc = Rpc.make(WS_METHODS.claudeListAccountProfiles, {
  payload: ClaudeAccountProfilesInput,
  success: ClaudeAccountProfilesResult,
  error: Schema.Union([ClaudeAccountError, EnvironmentAuthorizationError]),
});

export const WsClaudeStartAccountLoginRpc = Rpc.make(WS_METHODS.claudeStartAccountLogin, {
  payload: ClaudeAccountLoginStartInput,
  success: ClaudeAccountLoginStartResult,
  error: Schema.Union([ClaudeAccountError, EnvironmentAuthorizationError]),
});
...
export const WsClaudeCurrentAccountUsageRpc = Rpc.make(WS_METHODS.claudeCurrentAccountUsage, {
  payload: ClaudeCurrentUsageInput,
  success: ClaudeCurrentUsageResult,
  error: Schema.Union([ClaudeAccountError, EnvironmentAuthorizationError]),
});

export const WsThreadsRewindToInputRpc = Rpc.make(WS_METHODS.threadsRewindToInput, {
  payload: ThreadsRewindToInputInput,
  success: ThreadsRewindToInputResult,
  error: Schema.Union([ProviderRewindError, EnvironmentAuthorizationError]),
});

export const WsVcsFetchRemoteRpc = Rpc.make(WS_METHODS.vcsFetchRemote, {
  payload: VcsFetchRemoteInput,
  success: Schema.Struct({}),
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError]),
});
 ...
 * Not the persisted CH3 Review model. Future review sessions should use
