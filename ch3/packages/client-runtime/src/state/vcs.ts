...
import { applyGitStatusStreamEvent } from "@ch3tools/shared/git";
...
export function createVcsEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    fetchRemote: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:vcs:fetch-remote",
      tag: WS_METHODS.vcsFetchRemote,
      scheduler: vcsCommandScheduler,
      concurrency: vcsCommandConcurrency,
      onSettled: invalidateRefs,
    }),
