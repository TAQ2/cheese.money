import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@ch3tools/contracts";
...
}>("@ch3tools/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@ch3tools/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
