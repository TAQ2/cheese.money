...
import { RelayManagedEndpoint } from "@ch3tools/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@ch3tools/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@ch3tools/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
