import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@ch3tools/contracts";
import { resolveRemotePairingTarget } from "@ch3tools/shared/remote";
...
>()("@ch3tools/client-runtime/connection/onboarding/ConnectionOnboarding") {}
