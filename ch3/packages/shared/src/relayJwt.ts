...
export const RELAY_LINK_PROOF_TYP = "ch3-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "ch3-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "ch3-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "ch3-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "ch3-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "ch3-env-activity+jwt";
