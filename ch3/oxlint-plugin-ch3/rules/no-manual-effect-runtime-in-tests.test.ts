...
const rule = createOxlintRuleHarness("ch3/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("ch3/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("ch3/no-manual-effect-runtime-in-tests");
